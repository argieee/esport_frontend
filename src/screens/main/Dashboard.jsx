        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-5">
          ...
          <div className="xl:col-span-3 bg-[#0d131c] rounded-2xl border border-slate-800/60 overflow-hidden relative flex flex-col" style={{ minHeight: '360px' }}>
            ...
            <div className="relative z-10 flex items-center justify-between px-5 pt-5">
              <div className={`flex items-center gap-2 border rounded-full px-3 py-1.5 ${liveMatch.status === 'LIVE' ? 'bg-red-500/10 border-red-500/20' : 'bg-slate-500/10 border-slate-500/20'}`}>
            ...
            {}
            <div className="relative z-10 flex-1 w-full p-5 flex flex-col justify-center">
            ...
            <table className="w-full min-w-[560px]">
              ...
              <tbody className="divide-y divide-slate-800/30">
                {playerStats.length === 0 && (
                  <tr><td colSpan="6" className="px-5 py-8 text-center text-slate-500 text-sm">No player stats available for this tournament yet. Play some matches!</td></tr>
                )}
